...
$lang['SYNC_MEDIAINFO_ERROR'] = 'Metadata kan inte hämtas med MediaInfo eftersom XML-biblioteket saknas';
$lang['SYNC_METADATA_ERROR'] = 'Metadata kan inte hämtas eftersom ExifTool, FFprobe eller MediaInfo inte är installerade eller deras sökvägar är felaktiga.';
$lang['SYNC_NONE'] = 'Du bad mig att inte göra någonting!';
$lang['SYNC_POSTEROVERLAY_ERROR'] = 'Filmeffekten inaktiverad eftersom GD-biblioteket saknas.';
$lang['SYNC_POSTER_ERROR'] = 'Skapande av affischer och miniatyrer har inaktiverats eftersom FFmpeg inte är installerat eller att sökvägen är felaktig.';
$lang['SYNC_REPRESENTATIVES'] = 'Anta affischer som laddas upp manuellt';
$lang['SYNC_REPRESENTATIVES_DESC'] = 'För varje video uppdateras informationen som är relaterad till dess affisch.';
$lang['VIDEOJS_SETTINGS'] = 'VideoJS inställningar';
$lang['VIDEO_SRC'] = 'Filmkällor';